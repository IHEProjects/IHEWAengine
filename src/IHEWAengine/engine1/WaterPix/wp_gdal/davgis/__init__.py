...
try:
    from .functions import \
        Buffer, Feature_to_Raster, List_Fields, \
        ...
        Extract_Band, Get_Extent, \
        Interpolation_Default, Kriging_Interpolation_Points, Kriging_Interpolation_Array
except ImportError:
    from IHEWAengine.Engine1.WaterPix.wp_gdal.davgis.functions import \
        Buffer, Feature_to_Raster, List_Fields, \
        Raster_to_Array, Resample, Array_to_Raster, Clip, \
        Raster_to_Points, Add_Field, Spatial_Reference, \
        List_Datasets, NetCDF_to_Raster, Apply_Filter, \
