...
for ID, metadata in basins.items():
    ...
    if steps['Create Sheet 4 and 6']:
        complete_data = sh4.create_sheet4_6(complete_data, metadata, output_dir,
                                            global_data)
    ...
    if steps['Create Sheet 5']:
        complete_data = sh5.create_sheet5(complete_data, metadata, output_dir,
                                          global_data)

    if steps['Create Sheet 1']:
        complete_data, all_sh1_results = sh1.create_sheet1(complete_data, metadata,
